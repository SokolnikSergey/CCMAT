...
class ActionPerformer(QObject):
    ...
    action_done = pyqtSignal(object,dict)
    ...
    def __init__(self,action_queue = None,operations_executor = None,balance_info_configurator = None):
        ...
        self.___balance_inforation_configurator = balance_info_configurator
    ...
    def start_executing(self):
        while(self.__action_queue.size()):
            ...
            if action_type ==  ACTIONS.InformMe:
                ...
                balance = self.___balance_inforation_configurator.keep_amount_of_money(data["currency"],data["amount_money_to_reserve"])
                if ( balance != -1 ) :
                ...
                if(self.__operations_executor.withdraw(data["currency"],data["reciever"],data["amount"])):
                    ...
                    self.___balance_inforation_configurator.take_into_account_btc_outflow(data["currency"],data["amount"])
